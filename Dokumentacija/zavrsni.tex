...
Korištenjem \textit{FastAdvW} načina učenja postigli smo modele robustnosti otprilike jednake robusnosti \textit{PGD} modela, ali s potrebnih skoro dvostruko manje vremena za učenje.
