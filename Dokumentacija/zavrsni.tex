...
Jednom kada znamo iznos gubitka, računajući iznose gradijenata za pojedine težine (parcijalne derivacije gubitka po težinama) iste možemo izmijeniti. Iterativnim ponavljanjem ovakvog postupka minimiziramo iznos pogreške koristeći gradijentni spust.
