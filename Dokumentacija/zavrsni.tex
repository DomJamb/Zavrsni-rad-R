...
Po dobivenim rezultatima, čak ni model učen PGD-om s ograničenjem L\textsubscript{2} norme i velikim iznosom koeficijenta $\epsilon$ ne nudi nam otpornost na zatrovane podatke.
...
Nažalost, došli smo do zaključka da klasične implementacije robusnog učenja poput modela učenih PGD-om s ograničenjem L\textsubscript{$\infty$} norme ili metodom \textit{FastAdv} ne mogu izravno detektirati zatrovane podatke jer, kao i modeli učeni prirodnim učenjem, 
