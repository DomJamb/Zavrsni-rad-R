...
\begin{figure}[htb]
    \centering
    \includegraphics[scale=0.375]{../adv_imgs_multiple_models/eps_32_255_full.png}
...
Neprijateljski primjeri konstruirani su koristeći napad PGD s 20 iteracija i koeficijentom $\epsilon$ iznosa 32/255. 
Prvi redak predstavlja prirodne slike, drugi redak neprijateljske primjere konstruirane za model učen prirodnim učenjem, a preostali retci neprijateljske primjere konstruirane za modele učene različitim algoritmima učenja s neprijateljskim primjerima.
Iznad slika u prvom retku možemo vidjeti imena ispravnih razreda, dok iznad slika u preostalim retcima možemo vidjeti imena predviđenih razreda.
Iz naslova svakog osim prvog retka možemo saznati korišteni algoritam za učenje modela. U slučaju da naziv algoritma ima sufiks \textit{Early}, korišteno je učenje s ranim zaustavljanjem.
...
Nažalost, došli smo do zaključka da klasične implementacije robusnog učenja poput modela učenih PGD-om s ograničenjem $L_\infty$ norme ili metodom \textit{FastAdv} ne mogu izravno detektirati zatrovane podatke jer, kao i modeli učeni prirodnim učenjem, 
