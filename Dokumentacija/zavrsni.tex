...
Uz iscrtavanje grafova i slika, koristeći Matplotlib možemo ih s lakoćom pohraniti.
...
U tablici~\ref{tbl:mjerenja_robusno_ucenje} stupac \textit{LR} označava stopu učenja, stupac \textit{Točnost} točnost na skupu za testiranje, a stupac \textit{20-PGD} točnost na neprijateljskim primjerima konstruiranim iz skupa za testiranje koristeći napad PGD s 20 iteracija.
...
Ipak, rano zaustavljanje učenja ograničava nas jer modele ne možemo proizvoljno dugo učiti. 
